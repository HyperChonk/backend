...
const POOLS_METADATA_URL = 'https://raw.githubusercontent.com/hyperchonk/v3-metadata/main/pools/featured.json';

const TOKEN_LIST_URL =
    'https://raw.githubusercontent.com/hyperchonk/tokenlists/refs/heads/main/generated/balancer.tokenlist.json';
...
export class GithubContentService {
    async syncTokenContentData(chains: Chain[]): Promise<void> {
        ...
        const whitelistedTokens = await prisma.prismaTokenType.findMany({
            ...
            where: { type: PrismaTokenTypeOption.WHITE_LISTED, chain: { in: chains } },
        });
