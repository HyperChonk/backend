...
const config = {
    ARBITRUM: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/DLuE98kEb5pQNXAcKFQGQgfSQ57Xdou4jnVbAEqMfy3B`,
    },
    AVALANCHE: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/2h9woxy8RTjHu1HJsCEnmzpPHFArU33avmUh4f71JpVn`,
    },
    BASE: {
    ...
    GNOSIS: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/HtcDaL8L8iZ2KQNNS44EBVmLruzxuNAz1RkBYdui1QUT`,
    },
    MAINNET: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/Cd2gEDVeqnjBn1hSeqFMitw8Q1iiyV9FYUZkLNRcL87g`,
    },
    OPTIMISM: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/DSfLz8oQBUeU5atALgUFQKMTSYV9mZAVYp4noLSXAfvb`,
    },
    POLYGON: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/Co2URyXjnxaw8WqxKyVHdirq9Ahhm5vcTs4dMedAq211`,
    },
    SONIC: {
        subgraphURL: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/FQcacc4ZJaQVS9euWb76nvpSq2GxavBnUM6DU6tmspbi`,
    },
};
