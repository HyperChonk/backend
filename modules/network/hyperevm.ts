...
export const data: NetworkData = config.HYPEREVM;
...
export const hyperevmNetworkConfig: NetworkConfig = {
    ...
    services: {
        balancerSubgraphService: new BalancerSubgraphService(data.subgraphs.balancer, 'HYPEREVM'),
    },
    /*
    ...
    */
    workerJobs: [
        ...
        // Protocol metrics caching for TVL and analytics
        {
