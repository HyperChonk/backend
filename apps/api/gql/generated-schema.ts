...
export interface Mutation {
    ...
    tokenSetManualPrice: Scalars['String'];
...
export interface MutationTokenSetManualPriceArgs {
    chain: GqlChain;
    price: Scalars['Float'];
...
export interface Query {
    ...
    debugBulkTestLogs: Array<DebugLogResult>;
    debugTestLogs: DebugLogResult;
    debugTestStructuredLogs: Array<DebugLogResult>;
...
export interface QueryDebugBulkTestLogsArgs {
    count?: InputMaybe<Scalars['Int']>;
    levels?: InputMaybe<Array<Scalars['String']>>;
}

export interface QueryDebugTestLogsArgs {
    includeMetadata?: InputMaybe<Scalars['Boolean']>;
    level?: InputMaybe<Scalars['String']>;
    message?: InputMaybe<Scalars['String']>;
}

export interface QueryDebugTestStructuredLogsArgs {
    chainId?: InputMaybe<Scalars['String']>;
    jobName?: InputMaybe<Scalars['String']>;
    simulateJobFlow?: InputMaybe<Scalars['Boolean']>;
}
...
export type ResolversTypes = ResolversObject<{
    ...
    DebugLogResult: ResolverTypeWrapper<DebugLogResult>;
...
export type DebugLogResultResolvers<
    ContextType = ResolverContext,
    ParentType extends ResolversParentTypes['DebugLogResult'] = ResolversParentTypes['DebugLogResult'],
> = ResolversObject<{
    logLevel?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
> = ResolversObject<{
    ...
    >;
    tokenSetManualPrice?: Resolver<
        ResolversTypes['String'],
        ParentType,
        ContextType,
        RequireFields<MutationTokenSetManualPriceArgs, 'chain' | 'price' | 'tokenAddress'>
    >;
...
> = ResolversObject<{
    ...
    debugBulkTestLogs?: Resolver<
        Array<ResolversTypes['DebugLogResult']>,
        ParentType,
        ContextType,
        RequireFields<QueryDebugBulkTestLogsArgs, 'count' | 'levels'>
    >;
    debugTestLogs?: Resolver<
        ResolversTypes['DebugLogResult'],
        ParentType,
        ContextType,
        RequireFields<QueryDebugTestLogsArgs, 'includeMetadata' | 'level' | 'message'>
    >;
    debugTestStructuredLogs?: Resolver<
        Array<ResolversTypes['DebugLogResult']>,
        ParentType,
        ContextType,
        RequireFields<QueryDebugTestStructuredLogsArgs, 'chainId' | 'jobName' | 'simulateJobFlow'>
    >;
...
export type Resolvers<ContextType = ResolverContext> = ResolversObject<{
    ...
    DebugLogResult?: DebugLogResultResolvers<ContextType>;
