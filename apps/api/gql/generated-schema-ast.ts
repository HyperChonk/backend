...
export const schema = gql`
    ...
    type Mutation {
        ...
        tokenSetManualPrice(chain: GqlChain!, price: Float!, timestamp: Int, tokenAddress: String!): String!
    ...
    type Query {
        ...
        debugBulkTestLogs(count: Int = 5, levels: [String!] = ["info", "warn", "error"]): [DebugLogResult!]!
        debugTestLogs(
            includeMetadata: Boolean = true
            level: String = "info"
            message: String = "Test log message"
        ): DebugLogResult!
        debugTestStructuredLogs(
            chainId: String = "1"
            jobName: String = "test-job"
            simulateJobFlow: Boolean = true
        ): [DebugLogResult!]!
