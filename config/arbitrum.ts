...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancer: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmPbjY6L1NhPjpBv7wDTfG9EPx5FpCuBqeg1XxByzBTLcs`,
        ...
        cowAmm: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmUDGSJXdMzG4ezDzf1LvXVb2igwY6rnaNFLC62ZJZ3Pbv`,
        gauge: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmT3h6pogdPkxfWsBxKNtpq7kR9fqKaQ9jGxe7fZx7MUVE`,
    ...
    rpcUrl: env.RPC_API_KEY
        ? env.RPC_URL_TEMPLATE.replace('${network}', 'arbitrum').replace('${apiKey}', env.RPC_API_KEY)
        : 'https://1rpc.io/arb',
