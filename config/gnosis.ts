...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancer: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmXXSKeLh14DnJgR1ncHhAHciqacfRshcHKXasAGy7LP4Y`,
        ...
        gauge: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmPyH9BbVshMZRp5T7WBPnx1J5GVi46GX2NmheRQUkqF39`,
        aura: 'https://data.aura.finance/graphql',
        cowAmm: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/Qmb9jmxb2EVWHk7NryKCAbsq2WAZaCV4CmnZne59EbADeh`,
    },
    hooks: {
    ...
    rpcUrl: env.RPC_API_KEY
        ? env.RPC_URL_TEMPLATE.replace('${network}', 'gnosis').replace('${apiKey}', env.RPC_API_KEY)
