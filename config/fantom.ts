...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancer: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_FANTOM}/deployments/id/Qme9r1RTFZ6hEZ4ebPSmo3J81FNHhjeNZs5nBaSGTzb2hb`,
        beetsBar: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_FANTOM}/deployments/id/QmXcxzZioHXV5ts2UcG6gNNEayoaZ9ip7D9JvPS88K2HXe`,
        masterchef: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_FANTOM}/deployments/id/QmZQJu1rxMEDwzZb5TSqDXjcFiS1DN8BRKCLKRv6ifEBhA`,
        reliquary: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_FANTOM}/deployments/id/QmQB4iZpeX9eYgLUaiBt2HwkobqE3NzVUiupXF6Ha9Nzbk`,
        sftmx: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_FANTOM}/deployments/id/QmaD9zWMc6kQrBVbtjXNjNjbhpGWUHQFQdxABBEaVJqK5s`,
    },
    eth: {
    ...
    rpcUrl: env.RPC_API_KEY
        ? env.RPC_URL_TEMPLATE.replace('${network}', 'fantom').replace('${apiKey}', env.RPC_API_KEY)
        : 'https://1rpc.io/ftm',
