...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancer: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmNudbtVu2eACfxNpFz37MVwKxxHPh1Lg5MzFKwQZG2xsU`,
        ...
        gauge: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmQYUD5riMQmA8yzJQjSFonEZxkA9PLEoaxpQVjQdnBPHM`,
    ...
    rpcUrl: env.RPC_API_KEY
        ? env.RPC_URL_TEMPLATE.replace('${network}', 'avalanche').replace('${apiKey}', env.RPC_API_KEY)
