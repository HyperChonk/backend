...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancerV3: ``,
        cowAmm: ``,
        gauge: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmewSgLJf9TZt8trr61dECJhEGGyHxKFWbNQ3AnNZAdYyU`,
    ...
    rpcUrl: env.RPC_API_KEY
        ? env.RPC_URL_TEMPLATE.replace('${network}', 'polygon').replace('${apiKey}', env.RPC_API_KEY)
    ...
    ybAprConfig: {
        aave: {
            v2: {
                subgraphUrl: `https://gateway-arbitrum.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/subgraphs/id/H1Et77RZh3XEf27vkAmJyzgCME2RSFLtDS2f4PPW6CGp`,
                tokens: {
                    USDC: {
